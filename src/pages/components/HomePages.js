        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white">
              {props.home.bannerHeading}
            </h1>
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              {props.home.bannerDescription}
            </p>
            {props.home.bannerBtnText.map((item, i) => {
              return (
                <a
                  href={item.btnUrl}
                  key={i}
                  className={
                    i <= 0
                      ? "inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900"
          ...
          <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img src={props.home.bannerImage.sourceUrl} alt="mockup" />
          </div>
        </div>
      </section>
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
          <h2 className="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">
            {props.home.goodCompanyHeading}
          </h2>
          <div className="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-6 dark:text-gray-400 items-center">
            {props.home.goodCompanyImages.map((item, i) => {
              return <img key={i} src={item.image.sourceUrl} alt="mockup" />;
            })}
          </div>
        </div>
      </section>
